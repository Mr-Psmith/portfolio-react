                ...
                <div className={classes.aboutMain}>
                    <div className={classes.aboutBlock1}>
                        ...
                        <div className={classes.aboutBlock1_desc}>
                            ...
                            <p className={classes.aboutBlock1_descP}>I mastered Css, Javascript, and React, finished my portfolios, and other works and I am currently learning NodeJs while I am working freelance.</p>
