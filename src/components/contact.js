               ...
               <div className={classes.contactUnvisibleblock1}>
                  <form method="get" encType="text/plain">
                     ...
                     <div>
                        ...
                        <textarea className={classes.formContactMessageTextarea} name="comments" rows="12" cols="30">
                           This is a work in progress, as I am mainly a front-end developer, and I am still just training in back-end. But my email is psancthus@gmail.com . Thank you
                        </textarea>
                     </div>
